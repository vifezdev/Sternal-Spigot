...
public abstract class MinecraftServer implements Runnable, ICommandListener, IAsyncTaskHandler, IMojangStatistics {
        ...
        for (int m = 0; m < worlds.size(); m++) {
            ...
            for (int k = -192; k <= 192 && this.isRunning(); k += 16) {
                for (int l = -192; l <= 192 && this.isRunning(); l += 16) {
                    ...
                    ++i;
                    worldserver.chunkProviderServer.getChunkAt(blockposition.getX() + k >> 4, blockposition.getZ() + l >> 4, () -> {}); // SternalSpigot - Async Spawn Chunks
                }
            }
        }
    ...
    public void B() {
        ...
        for (i = 0; i < this.worlds.size(); ++i) {
            ...
            // if (i == 0 || this.getAllowNether()) {
                ...
                worldserver.movementCache.clear(); // SternalSpigot - Movement Cache
            // } // CraftBukkit
    ...
    public String getServerModName() {
        return "SternalSpigot"; // SternalSpigot - SternalSpigot > // TacoSpigot - TacoSpigot > // PaperSpigot - PaperSpigot > // Spigot - Spigot > // CraftBukkit - cb > vanilla!
    }
