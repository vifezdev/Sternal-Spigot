...
public abstract class Entity implements ICommandListener {
    ...
    public double motY;
    public double motZ;
    // SternalSpigot start - Movement Cache
    ...
    public AxisAlignedBB boundingBox; // SternalSpigot - private -> public
    ...
    public int ticksLived; public int getTicksLived() { return ticksLived; }; // SternalSpigot
    ...
    public boolean isCannoningEntity; // SternalSpigot
    ...
    // SternalSpigot start - Lag Compensated Ticking
    ...
    // Spigot end
    public boolean naturalSpawn; // SternalSpigot
    ...
    public Entity(World world) {
        ...
        // Spigot end
        this.isCannoningEntity = this instanceof EntityTNTPrimed || this instanceof EntityFallingBlock; // SternalSpigot
    ...
    public void loadChunks() {
        // SternalSpigot start - Fix Load Chunks
        /*
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            world.movementCache.cache(this); // SternalSpigot - Movement Cache
            ...
            if (this.s_() && !flag && this.vehicle == null) {
                ...
                if (this.N > (float) this.h && block.getMaterial() != Material.AIR) {
                    ...
                    // SternalSpigot start - Disable footstep sounds
    ...
    protected void recalcPosition() { // SternalSpigot - private -> protected
    ...
    public void e(NBTTagCompound nbttagcompound) {
        try {
            ...
            nbttagcompound.setBoolean("FromMobSpawner", this.fromMobSpawner); // SternalSpigot
            nbttagcompound.setBoolean("NaturalSpawn", this.naturalSpawn); // SternalSpigot
        } catch (Throwable throwable) {
