...
public class Explosion {
    ...
    public void a() {
        ...
        // SternalSpigot start - Block Searching Improvements
        ...
        // SternalSpigot start - Faster Entity Iteration
    ...
    public void a(boolean flag) {
        ...
        if (this.b) {
            ...
            while (iterator.hasNext()) {
                ...
                // SternalSpigot start - Optimise Explosions
                /*
                if (flag) {
    ...
    private float getBlockDensity(Vec3D vec3d, AxisAlignedBB aabb) {
        ...
        // SternalSpigot start - Optimise Density
    ...
    /* // SternalSpigot - comment this out
