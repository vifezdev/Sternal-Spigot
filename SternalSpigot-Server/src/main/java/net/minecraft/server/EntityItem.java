...
public class EntityItem extends Entity implements HopperPusher {
    ...
    public void t_() {
        if (this.getItemStack() == null) {
            ...
            super.t_();
            if (ticksLived % world.ionConfig.hopperInterval == 0 && tryPutInHopper()) return; // SternalSpigot - Add Interval // TacoSpigot
            ...
            this.noclip = ticksLived % world.ionConfig.noclipInterval == 0 && this.j(this.locX, (this.getBoundingBox().b + this.getBoundingBox().e) / 2.0D, this.locZ); // SternalSpigot
            ...
            if (flag || this.ticksLived % 25 == 0) {
                ...
                if (!this.world.isClientSide && ticksLived % world.ionConfig.mergeInterval == 0) { // SternalSpigot
                    this.w();
                }
            }
    ...
    public boolean a(EntityItem entityitem) { // SternalSpigot - private -> public
        if (entityitem == this) {
            return false;
