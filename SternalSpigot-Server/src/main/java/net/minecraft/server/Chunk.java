...
public class Chunk {
    ...
    // PaperSpigot end
    public EntityItem cachedEntityItem; // SternalSpigot - Merge Spawned Items
    ...
    public Chunk(World world, int i, int j) {
        ...
        for (int k = 0; k < this.entitySlices.length; ++k) {
            this.entitySlices[k] = new io.papermc.paper.util.maplist.ObjectMapList<>(); // SternalSpigot - UnsafeList -> ObjectMapList // Spigot
        }
