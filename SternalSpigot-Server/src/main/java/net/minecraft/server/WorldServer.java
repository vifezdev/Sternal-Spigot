                ...
                */
                ...
                if (paperSpigotConfig.tickNextTickListCapIgnoresRedstone) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        if (next.a().isPowerSource() || next.a() instanceof IContainer || next.a() instanceof BlockFalling) { // SternalSpigot - falling blocks should bypass tick cap
                            iterator.remove();
                            this.V.add(next);
                        }
                    }
                ...
                this.dispenserOrder.dispatch(); // SternalSpigot - Column Spawning
                this.methodProfiler.b();
                this.V.clear();
