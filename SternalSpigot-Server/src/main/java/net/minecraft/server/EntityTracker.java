...
public class EntityTracker {
    ...
    private Set<EntityTrackerEntry> c = new io.papermc.paper.util.maplist.ObjectMapList<>(); // SternalSpigot - HashSet -> ObjectMapList
    ...
    public void addEntity(Entity entity, int i, final int j, boolean flag) {
        ...
        try {
            ...
            EntityTrackerEntry entitytrackerentry = createTracker(entity, i, j, flag); // SternalSpigot
