...
public abstract class World implements IBlockAccess {
    ...
    // SternalSpigot start - Optimise Density Cache
    public final it.unimi.dsi.fastutil.ints.Int2FloatMap explosionDensityCache = new it.unimi.dsi.fastutil.ints.Int2FloatOpenHashMap(); // SternalSpigot - Use faster collection here // PaperSpigot - Optimize explosions
    {
        explosionDensityCache.defaultReturnValue(-1.0f);
    }
    // SternalSpigot end
    public final MovementCache movementCache = new MovementCache(); // SternalSpigot - Movement Cache
    public DispenserOrder dispenserOrder = new NormalSpawning(); // SternalSpigot - Column Spawning
    ...
    public final me.suicidalkids.ion.IonWorldConfig ionConfig; // SternalSpigot - TacoSpigot broke the chain ^
    ...
    protected World(IDataManager idatamanager, WorldData worlddata, WorldProvider worldprovider, MethodProfiler methodprofiler, boolean flag, ChunkGenerator gen, org.bukkit.World.Environment env) {
        ...
        this.ionConfig = new me.suicidalkids.ion.IonWorldConfig(this, worlddata.getName()); // SternalSpigot
        this.generator = gen;
    ...
    public boolean setTypeAndData(BlockPosition blockposition, IBlockData iblockdata, int i) {
        ...
        if (!this.isValidLocation(blockposition)) {
            ...
            if (iblockdata1 == null) {
                ...
                movementCache.clear(); // SternalSpigot - Movement Cache
                /*
    ...
    // SternalSpigot start - Merge Spawned Items
    ...
    public List<AxisAlignedBB> getCubes(Entity entity, AxisAlignedBB axisalignedbb) {
        ...
        if (!ionConfig.movementEntityCollisions) return arraylist; // SternalSpigot - Optimise general movement...
    ...
    public void tickEntities() {
        ...
        Entity lastEntity = null; // SternalSpigot - Merge Cannoning Entities
        for (tickPosition = 0; tickPosition < entityList.size(); tickPosition++) {
            ...
            if (!entity.dead) {
                try {
                    // SternalSpigot start - Merge Cannoning Entities
    ...
    // SternalSpigot start - Optimise Entity Collisions
