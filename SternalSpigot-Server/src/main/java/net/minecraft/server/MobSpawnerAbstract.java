...
public abstract class MobSpawnerAbstract {
    ...
    private double e;
    private double f;
    // SternalSpigot start - Configurable Spawners
    ...
    public void c() {
        ...
        // PaperSpigot end
        if (!this.a().ionConfig.requirePlayers || this.g()) { // SternalSpigot
            BlockPosition blockposition = this.b();
            double d0;
            ...
            if (this.a().isClientSide) {
                ...
                for (int i = 0; i < this.spawnCount; ++i) {
                    ...
                    int j = !this.a().ionConfig.checkMaxEntities ? -1 : this.a().a(entity.getClass(), (new AxisAlignedBB((double) blockposition.getX(), (double) blockposition.getY(), (double) blockposition.getZ(), (double) (blockposition.getX() + 1), (double) (blockposition.getY() + 1), (double) (blockposition.getZ() + 1))).grow((double) this.spawnRange, (double) this.spawnRange, (double) this.spawnRange)).size(); // SternalSpigot
                    ...
                    if (entityinsentient == null || !this.a().ionConfig.checkConditions && this.a().getCubes(entityinsentient, entityinsentient.getBoundingBox()).isEmpty() || this.a().ionConfig.checkConditions && entityinsentient.bR() && entityinsentient.canSpawn()) { // SternalSpigot
                        this.a(entity, true);
