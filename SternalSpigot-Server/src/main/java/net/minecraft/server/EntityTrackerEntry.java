...
import me.suicidalkids.ion.visuals.Visuals; // SternalSpigot
...
public class EntityTrackerEntry {
    ...
    public java.util.Map<EntityPlayer, Boolean> trackedPlayerMap = new it.unimi.dsi.fastutil.objects.Reference2BooleanOpenHashMap<>(); // SternalSpigot - HashMap -> Reference2BooleanMap
        ...
        if (entityplayer != this.tracker) {
            if (this.c(entityplayer)) {
                if (!this.trackedPlayers.contains(entityplayer) && (this.e(entityplayer) || this.tracker.attachedToPlayer)) {
                    ...
                    Packet packet = this.createPacket(entityplayer); // SternalSpigot
                    if (packet == null) return; // SternalSpigot - If it's null don't update the client!
    ...
    protected boolean e(EntityPlayer entityplayer) { // SternalSpigot - private -> protected
    ...
    private Packet c() {
        // SternalSpigot start - Visibility Toggles
    ...
    protected Packet createPacket(EntityPlayer entityPlayer) {
        ...
        if (this.tracker instanceof EntityItem) {
            ...
            if (this.tracker instanceof EntityFireball) {
                ...
                // SternalSpigot start - Visibility Toggle
